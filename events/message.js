...
module.exports = {
    ...
    execute(message, client) {
            ...
            if (timestampt.has(message.author.id)) {
                ...
                if (now < expiration) {
                    ...
                    const embeduyarı = new Discord.MessageEmbed()
                        ...
                        .setColor('RED')
                    message.channel.send(embeduyarı).then(msg => {
        ...
        if (cmd.yetki) {
            ...
            `)
            .setColor('RED')
            if (!message.member.hasPermission(`${cmd.yetki}`)) return message.channel.send(yetkiyok)
        }
        ...
        if (cmd.botyetki) {
            ...
            const botyetkiyok = new Discord.MessageEmbed()
            .setDescription(`
            ...
            `)
            .setColor('RED')
            if (!message.guild.me.hasPermission(`${cmd.botyetki}`)) return message.channel.send(botyetkiyok)
        }
